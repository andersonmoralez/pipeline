from src.drivers.interfaces.http_requester import HttpResquesterInterface
from src.drivers.interfaces.html_collector import HtmlCollectorInterface

class ExtractHtml:
    def __init__(self, http_requester: HttpResquesterInterface, html_collector: HtmlCollectorInterface) -> None:
